...
- **流通盘口径分离**：历史 `free_float_pct` 不是港交所公众持股比例；长期区只展示私有仓逐页核实的上市公众持股分母，并把“基石锁定占比”和“解禁供给冲击”分开。
- **审阅完成不等于数值齐全**：长期目标样本已完成 69/69 港交所材料收集与 69/69 人工裁决；未明确披露的关系仍保持缺失。网页分别展示审阅进度、可审计值和各因子实际覆盖，浏览器不自动判定身份。
